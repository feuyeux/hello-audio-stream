...
class WebSocketMessage:
    ...
    @classmethod
    def started(
        cls, stream_id: str, message: str = "Stream started successfully"
    ) -> "WebSocketMessage":
    ...
    @classmethod
    def stopped(
        cls, stream_id: str, message: str = "Stream finalized successfully"
    ) -> "WebSocketMessage":
    ...
    @classmethod
    def connected(
        cls, connection_id: str, message: str = "Connection established"
    ) -> "WebSocketMessage":
        """Create a CONNECTED response message."""
        return cls(type="CONNECTED", streamId=connection_id, message=message)
