...
class AudioWebSocketServer:
    ...
    async def handle_client(self, websocket: ServerConnection):
        ...
        connected_msg = self.message_handler.connected(
            connection_id, "Connection established"
        )
        await websocket.send(connected_msg.to_json())
        logger.info(f"Sent CONNECTED message to client: {connection_id}")
