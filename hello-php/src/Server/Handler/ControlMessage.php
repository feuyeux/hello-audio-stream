...
/**
 * WebSocket control message class for JSON serialization/deserialization.
...
class ControlMessage
{
     ...
     */
    public static function connected(string $connectionId, string $message = 'Connection established'): self
    {
        return new self('CONNECTED', $connectionId, null, null, $message);
    }
